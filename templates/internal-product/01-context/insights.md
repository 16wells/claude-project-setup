...
- Notice a pattern in the buyer's behavior, the domain, or the product itself
...
- External dependencies we're waiting on → go to `decisions-log.md` under Outstanding External Dependencies
...
| An external dependency we're waiting on | `decisions-log.md` → Outstanding External Dependencies |
